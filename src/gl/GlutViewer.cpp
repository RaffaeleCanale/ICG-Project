...
GlutViewer::GlutViewer(const char* _title, int _width, int _height) : width_(_width), height_(_height), draw_mode_(SOLID_SMOOTH), fullscreen_(false) {
	// create window
	...
	// register callbacks
	// Those are the functions that glut will call when asked to do some specific operations
...
/**
* From here to next separation, simply delegate method from static to currentWindow
*/
